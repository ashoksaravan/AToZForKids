...
public class DataStore {
    ...
    public List<ItemsDTO> getAlphabets() {
        if (alphabets == null) {
            ...
            alphabets.add(new ItemsDTO("Cat", R.drawable.cat, R.raw.cat));
            alphabets.add(new ItemsDTO("Dog", R.drawable.dog, R.raw.dog));
            alphabets.add(new ItemsDTO("Elephant", R.drawable.elephant, R.raw.elephant));
            alphabets.add(new ItemsDTO("Fish", R.drawable.fish));
            alphabets.add(new ItemsDTO("Goat", R.drawable.goat, R.raw.goat));
            alphabets.add(new ItemsDTO("Horse", R.drawable.horse, R.raw.horse));
            ...
            alphabets.add(new ItemsDTO("Lion", R.drawable.lion, R.raw.lion));
            alphabets.add(new ItemsDTO("Mango", R.drawable.mango));
            alphabets.add(new ItemsDTO("Nest", R.drawable.nest));
            alphabets.add(new ItemsDTO("Owl", R.drawable.owl, R.raw.owl));
            alphabets.add(new ItemsDTO("Pig", R.drawable.pig, R.raw.pig));
            alphabets.add(new ItemsDTO("Quail", R.drawable.quail));
            alphabets.add(new ItemsDTO("Rabbit", R.drawable.rabbit));
            alphabets.add(new ItemsDTO("Swan", R.drawable.swan, R.raw.swan));
            ...
            alphabets.add(new ItemsDTO("Zebra", R.drawable.zebra, R.raw.zebra));
        }
        return alphabets;
    }
    ...
    public List<ItemsDTO> getAnimals() {
        if (animals == null) {
            ...
            animals.add(new ItemsDTO("Ant", R.drawable.ant));
            animals.add(new ItemsDTO("Bat", R.drawable.bat, R.raw.bat));
            ...
            animals.add(new ItemsDTO("Chameleon", R.drawable.chameleon));
            ...
            animals.add(new ItemsDTO("Crab", R.drawable.crab));
            ...
            animals.add(new ItemsDTO("Dolphin", R.drawable.dolphin, R.raw.dolphin));
            ...
            animals.add(new ItemsDTO("Hyena", R.drawable.hyena));
            ...
            animals.add(new ItemsDTO("Lobster", R.drawable.lobster));
            ...
            animals.add(new ItemsDTO("Octopus", R.drawable.octopus));
            ...
            animals.add(new ItemsDTO("Prawn", R.drawable.prawn));
            ...
            animals.add(new ItemsDTO("Snail", R.drawable.snail));
